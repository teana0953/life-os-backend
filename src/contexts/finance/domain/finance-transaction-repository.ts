import type { CreateFinanceTransactionInput, FinanceTransaction, UpdateFinanceTransactionFields } from "./finance-transaction";
...
export interface FinanceTransactionRepository {
  ...
  update(userId: string, id: string, input: UpdateFinanceTransactionFields): Promise<FinanceTransaction | null>;
