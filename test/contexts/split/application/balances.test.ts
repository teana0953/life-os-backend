...
import { InMemoryBalanceRepository, InMemoryExpenseGroupRepository, InMemoryFriendChecker, InMemorySplitExpenseRepository, TestUserDirectory } from "../fakes";
...
beforeEach(() => {
  ...
  users.add(C, "Carol");
  users.add(D, "Dave");
  balances = new InMemoryBalanceRepository(expenses, groups, users);
